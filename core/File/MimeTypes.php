 ...
 *
 * This file is part of the Symfony MimeTypes package.
 */
final class MimeTypes
{
    ...
    {
        if (null !== self::MAP[$mimeType]) {
            return self::MAP[$mimeType];
        }
        $lowerType = strtolower($mimeType);
        if (null !== self::MAP[$lowerType]) {
            return self::MAP[$lowerType];
        }
        return [];
    }
    ...
    {
        if ($this->mimeTypes) {
            $mimeTypes = isset($this->mimeTypes[$ext]) ? $this->mimeTypes[$ext]
                : (isset($this->mimeTypes[$lcExt = strtolower($ext)]) ? $this->mimeTypes[$lcExt = strtolower($ext)] : null);
        }

        if (isset($mimeTypes)) {
            return $mimeTypes;
        }
        if (null !== self::REVERSE_MAP[$ext]) {
            return self::REVERSE_MAP[$ext];
        }
        if (isset($lcExt) && null !== self::REVERSE_MAP[$lcExt]) {
            return self::REVERSE_MAP[$lcExt];
        }
        $lowerExt = strtolower($ext);
        if (null !== self::REVERSE_MAP[$lowerExt]) {
            return self::REVERSE_MAP[$lowerExt];
        }
        return [];
    }
