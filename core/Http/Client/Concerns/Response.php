...
namespace Core\Http\Client\Concerns;

use ArrayAccess;
use Core\Support\Traits\MacroAble;
use LogicException;
use Core\Http\Client\RequestException;
...
class Response implements ArrayAccess
{
     ...
     *
     * @return \Core\Http\Client\RequestException|null
     */
     ...
     * @return $this
     *
     * @throws \Core\Http\Client\RequestException
     */
